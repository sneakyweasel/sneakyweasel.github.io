...
- [Webby Awards 2023](https://www.webbyawards.com/crafted-with-code/virtual-quantum-lab/), the "Oscars of the Internet": nominee in the Science category with the Quantum Flytrap team for Virtual Quantum Lab, alongside NASA's Jet Propulsion Laboratory and OpenAI; covered by [Quantum Zeitgeist](https://quantumzeitgeist.com/quantum-flytraps-virtual-quantum-lab-receives-webby-award-nomination-quantum-game-gets-worldwide-recognition/).
- [Étoile Civique](https://www.etoilecivique.fr/), bronze, 2013, for more than ten years of charitable and humanitarian work around the world.
- France 3 interview about my 3D printing farm at Hôpital Cochin at the beginning of the Covid-19 pandemic.
