...
- [Webby Awards 2023](https://www.webbyawards.com/crafted-with-code/virtual-quantum-lab/), les « Oscars d'Internet » : nommé dans la catégorie Science avec l'équipe de Quantum Flytrap pour Virtual Quantum Lab, aux côtés du Jet Propulsion Laboratory de la NASA et d'OpenAI ; article dans [Quantum Zeitgeist](https://quantumzeitgeist.com/quantum-flytraps-virtual-quantum-lab-receives-webby-award-nomination-quantum-game-gets-worldwide-recognition/).
- [Étoile Civique](https://www.etoilecivique.fr/) de bronze, 2013, pour plus de dix ans d'engagement caritatif et humanitaire à travers le monde.
